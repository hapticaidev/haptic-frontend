	...
	return (
		<div className='relative flex size-full flex-col'>
			<h4
				...
				className='font-ppf mx-9 mt-8 text-[2.5rem] font-extrabold uppercase leading-[4.236rem] tracking-[-0.03em] sm:mx-[7.25rem] sm:mt-[4.25rem] sm:text-[4.236rem] min-[1400px]:mt-[9.625rem]'>
				How can we help?
			</h4>
			<p
				// eslint-disable-next-line tailwindcss/no-custom-classname
