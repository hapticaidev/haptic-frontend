	...
	return (
		<div className='flex w-full flex-col items-center justify-center px-3.5 uppercase md:px-9 lg:pt-[11.188rem] bg-[#010001] pt-[10.214rem] md:pt-[15.813rem]'>
			<div
				...
				className='font-ppf text-[#F8FDFF] mb-[2.119rem] mt-[0.779rem] max-w-[22.688rem] text-center text-[1.75rem] font-extrabold leading-[2.063rem] tracking-[-0.03em] lg:mb-[4.25rem] lg:mt-[1.563rem] lg:max-w-[43.75rem] lg:text-[2.75rem] lg:leading-[3.142rem]'>
				{partenersData.title}
			</div>
			...
			<div className='mx-auto mb-[13.958rem] mt-[13.664rem] flex flex-col items-center lg:mb-[13.146rem] lg:mt-[11.104rem]'>
				...
				<p
					// eslint-disable-next-line tailwindcss/no-custom-classname
					className='font-ppf text-[#F8FDFF] mx-auto mb-[2.119rem] mt-[0.779rem] max-w-[22.688rem] text-center text-[1.75rem] font-extrabold leading-[2.063rem] tracking-[-0.03em] lg:mb-[4.25rem] lg:mt-[1.563rem] lg:max-w-[43.75rem] lg:text-[2.75rem] lg:leading-[3.142rem]'>
