	...
	return (
		<div className='flex w-full flex-col items-center justify-center px-3.5 pt-[4.313rem] uppercase md:px-9 lg:pt-[11.188rem]'>
			<div
				...
				className='font-ppf w-full max-w-[22.688rem] self-start text-left text-[1.75rem] font-extrabold leading-[2.063] tracking-[-0.03em] md:max-w-[87.5rem] lg:text-[2.618rem] lg:leading-[3.142rem]'>
				{partenersData.title}
			</div>
			...
			<div className='mx-auto mb-[13.958rem] mt-[13.664rem] flex flex-col items-center lg:mb-[13.146rem] lg:mt-[11.104rem]'>
				...
				<p
					// eslint-disable-next-line tailwindcss/no-custom-classname
					className='font-ppf mx-auto mb-[2.119rem] mt-[0.779rem] max-w-[22.688rem] text-center text-[1.75rem] font-extrabold leading-[2.063rem] tracking-[-0.03em] lg:mb-[4.25rem] lg:mt-[1.563rem] lg:max-w-[43.75rem] lg:text-[2.618rem] lg:leading-[3.142rem]'>
